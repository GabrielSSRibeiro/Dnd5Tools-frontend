...
import { DEFAULT_CREATURE_DIFICULTY, CREATURE_DIFICULTIES, COMBAT_DIFICULTIES } from "../../../Tables/combat";
              ...
              {selectedCreatures &&
                selectedCreatures.map((creature, index) => (
                  <div className="creature-details">
                    ...
                    <Select extraWidth={100} value={DEFAULT_CREATURE_DIFICULTY} onSelect={() => {}} options={CREATURE_DIFICULTIES} />
