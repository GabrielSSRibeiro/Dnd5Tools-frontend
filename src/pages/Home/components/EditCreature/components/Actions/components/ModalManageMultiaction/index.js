...
function ModalManageMultiaction({ multiaction, onClose }) {
  const [tempMultiaction, setTempMultiaction] = useState(
    multiaction ?? {
      name: null,
      description: null,
      type: null,
  ...
  function HandleConfirm() {
    onClose(tempMultiaction);
  }

  return (
    <div className="ModalManageMultiaction-container">
...
export default ModalManageMultiaction;
